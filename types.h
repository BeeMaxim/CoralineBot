...
// Swap A1 <-> A8
constexpr Square flip_rank(Square s) { return Square((int)s ^ (int)SQ_A8); } // AAAAA

// Swap A1 <-> H1
constexpr Square flip_file(Square s) { return Square((int)s ^ (int)SQ_H1); } // AAAAA
...
constexpr File file_of(Square s) { return File((int)s & 7); } // AAAAA

constexpr Rank rank_of(Square s) { return Rank(s >> 3); }

constexpr Square relative_square(Color c, Square s) { return Square((int)s ^ (c * 56)); } // AAAAA
